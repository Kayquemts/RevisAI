...
import { FileText, Eye, Trash2, X, Pencil, Check } from "lucide-react";
              ...
              {resumos.map((resumo) => (
                <div key={resumo.id} className="rounded-lg border bg-card text-card-foreground shadow-sm p-5 card-hover border-l-4 border-l-accent">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={() => handleStartEdit(resumo)}
                      title="Editar nome"
                    ...
                    <button
                      onClick={() => setConfirmDeleteId(resumo.id)}
                      title="Excluir"
